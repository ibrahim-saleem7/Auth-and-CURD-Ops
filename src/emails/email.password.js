module.exports = passwordResetForgetFormat = (code)=>{
    return `
    <!DOCTYPE html>
    <html>
    <head>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="center" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Enter the code in website to reset your password.</p>
            </td>
          </tr>
          <!-- end copy -->
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                          <p style="display: inline-block; padding: 10px 50px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 26px; color: #ffffff; text-decoration: none; border-radius: 6px;">${code}</p>
                        </td>
                      </tr>
                    </table>
                  </td>
